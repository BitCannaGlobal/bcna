...
1. Download the latest version (v.3.1.0) from Github:
    ```
    cd $HOME
    wget -nc https://github.com/BitCannaGlobal/bcna/releases/download/v3.1.0/bcna_linux_amd64.tar.gz
    ```
2. Check the sha256sum for the downloaded file. 
    ```
    sha256sum bcna_linux_amd64.tar.gz
    ```
    It must return: `7a714e976ef5d2589ce08736f9f12b15e44b2e63a80bf2fb86e82c2319ebcadf`

3. Verify that the version is `3.1.0`
    ```
