...
**bcnad** is a blockchain application built using Cosmos SDK v.0.47.7 and Comet-BFT v.0.37.4 and IBC-go v7.3.1.
...
1. Download the latest version (v.3.0.0) from Github:
    ```
    cd $HOME
    wget -nc https://github.com/BitCannaGlobal/bcna/releases/download/v3.0.0/bcna_linux_amd64.tar.gz
    ```
2. Check the sha256sum for the downloaded file. 
    ```
    sha256sum bcna_linux_amd64.tar.gz
    ```
    It must return: `f7bd61030fec97886838896f6799cfd7e7af9237447d54dce0d8fdffe93e4d27`

3. Verify that the version is `3.0.0`
    ```
