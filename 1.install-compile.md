...
1. Download the latest version (v.1.6.2) from Github:
    ```
    cd $HOME
    wget -nc https://github.com/BitCannaGlobal/bcna/releases/download/v1.6.2/bcna_linux_amd64.tar.gz
    ```
2. Check the sha256sum for the downloaded file. 
    ```
    sha256sum bcna_linux_amd64.tar.gz
    ```
    It must return: `43fe0914ab29c7a4fa4d8428c413de02b60197c1c3cd5c70b40094245701e077`

3. Verify that the version is `1.6.2`
    ```
