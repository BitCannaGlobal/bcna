...
import BcnaBurn from './bcna.burn'
import BitcannaglobalBcnaBcna from './bitcannaglobal.bcna.bcna'
...
export default { 
  BcnaBurn: load(BcnaBurn, 'bcna.burn'),
  BitcannaglobalBcnaBcna: load(BitcannaglobalBcnaBcna, 'bitcannaglobal.bcna.bcna'),
