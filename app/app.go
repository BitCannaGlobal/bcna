...
func New(
	...
	appCodec := encodingConfig.Marshaler // RBG https://github.com/cosmos/cosmos-sdk/blob/release/v0.47.x/simapp/app.go#LL224C2-L224C21
	...
	*/
	...
	// RBG app.mm.RegisterRoutes(app.Router(), app.QueryRouter(), encodingConfig.Amino)
